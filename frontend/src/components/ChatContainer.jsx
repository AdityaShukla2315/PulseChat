...
const ChatContainer = () => {
  ...
  // Auto-scroll to bottom when new messages arrive or user is at the bottom
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Fixed Input */}
      <div className="flex-shrink-0 border-t border-base-300 bg-base-100/80 backdrop-blur-sm p-4">
        <MessageInput />
      </div>
    </div>
  );
